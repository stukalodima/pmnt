...
alter table FINANCE_CASH_FLOW_ITEM add constraint FK_FINANCE_CASH_FLOW_ITEM_ON_PAYMENT_REGISTER_TYPE foreign key (PAYMENT_REGISTER_TYPE_ID) references FINANCE_PAYMENT_REGISTER_TYPE(ID)^
create index IDX_FINANCE_CASH_FLOW_ITEM_ON_PAYMENT_REGISTER_TYPE on FINANCE_CASH_FLOW_ITEM (PAYMENT_REGISTER_TYPE_ID)^
