package com.itk.finance.web.screens.accountchartbybusiness;
...
@UiController("finance_AccountsChartByBusiness")
@UiDescriptor("accounts-chart-by-business.xml")
public class AccountsChartByBusiness extends Screen {
    @Inject
    ...
    private void setColumnName(Date columnDate) {
        ...
        gtAccountsRemains.getColumn("before")
                .setCaption("<div style=\"text-align: right\">" +
                        messages.getMessage(AccountsChartByBusiness.class, "gtAccountsRemains.before") +
        ...
        gtAccountsRemains.getColumn("today")
                .setCaption("<div style=\"text-align: right; color: green;\">" +
                        messages.getMessage(AccountsChartByBusiness.class, "gtAccountsRemains.today") +
                        "<br>" + dateFormat.format(columnDate) + " (UAH)" + "</div"
                );
        gtAccountsRemains.getColumn("todayUAH")
                .setCaption("<div style=\"text-align: right\">" +
                        messages.getMessage(AccountsChartByBusiness.class, "gtAccountsRemains.todayUAH") +
                        "<br>" + dateFormat.format(columnDate) + " (UAH)" + "</div"
                );
        gtAccountsRemains.getColumn("todayUSD")
                .setCaption("<div style=\"text-align: right\">" +
                        messages.getMessage(AccountsChartByBusiness.class, "gtAccountsRemains.todayUSD") +
                        "<br>" + dateFormat.format(columnDate) + " (USD)" + "</div"
                );
        gtAccountsRemains.getColumn("todayEUR")
                .setCaption("<div style=\"text-align: right\">" +
                        messages.getMessage(AccountsChartByBusiness.class, "gtAccountsRemains.todayEUR") +
